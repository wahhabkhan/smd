                ...
                <td><?= $model->stakeholder_id ?></td>
                    ...
                    <td>
                        ...
                        <?= Html::a('View', ['stakeholder/view-stakeholder-details', 'stakeholder_id' => $model->stakeholder_id], ['class' => 'btn d-flex align-items-center rounded btn-danger ms-1']) ?> 
                            ...
                            <?= Html::a('Add Contact', ['contact/add-contact', 'stakeholder_id' => $model->stakeholder_id], ['class' => 'btn  rounded btn-info ms-1']) ?>
                        <?= Html::a('View Contacts', ['contact/view-contact', 'stakeholder_id' => $model->stakeholder_id], ['class' => 'btn  rounded btn-info ms-1']) ?>
                        </div>
                  </td>
            </tr>
            <?php endforeach; ?>  
